...
//    -- Percentile ranks
//    MAX(pct_rank_licensed_users) AS pct_rank_licensed_users,
//    MAX(pct_rank_active_licensed_users) AS pct_rank_active_licensed_users,
//    MAX(pct_rank_total_active_users) AS pct_rank_total_active_users,
//    MAX(pct_rank_unique_solution_owners) AS pct_rank_unique_solution_owners,
//    MAX(pct_rank_power_developers) AS pct_rank_power_developers,
//    MAX(pct_rank_total_solutions_per_account) AS pct_rank_total_solutions_per_account,
//    MAX(pct_rank_external_integrations) AS pct_rank_external_integrations,
//    MAX(pct_rank_internal_integrations) AS pct_rank_internal_integrations,
//    MAX(pct_rank_solutions_with_HVT) AS pct_rank_solutions_with_HVT,
//    MAX(pct_rank_solutions_with_external_users) AS pct_rank_solutions_with_external_users,
//    MAX(pct_rank_unique_external_collaborators) AS pct_rank_unique_external_collaborators,
//    MAX(pct_rank_solutions_created_last_90_days) AS pct_rank_solutions_created_last_90_days,
//    MAX(pct_rank_num_departments_per_solution) AS pct_rank_num_departments_per_solution,
//    MAX(pct_rank_unique_HVT_collaborators) AS pct_rank_unique_HVT_collaborators,
//    MAX(pct_rank_total_complexity_score) AS pct_rank_total_complexity_score,
//    MAX(pct_rank_automation_count) AS pct_rank_automation_count,
//    MAX(pct_rank_total_workflows) AS pct_rank_total_workflows,
//    MAX(pct_rank_unique_internal_collaborators) AS pct_rank_unique_internal_collaborators,
//    MAX(pct_rank_work_app_count) AS pct_rank_work_app_count,
//    MAX(pct_rank_external_views_with_work_app) AS pct_rank_external_views_with_work_app,
//    MAX(pct_rank_brandfolder_presence) AS pct_rank_brandfolder_presence
